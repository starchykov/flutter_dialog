...
class MessagesList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      padding: const EdgeInsets.symmetric(vertical: kTextSpaceDefault, horizontal: 8.0),
      keyboardDismissBehavior: ScrollViewKeyboardDismissBehavior.onDrag,
      controller: viewModel.scrollController,
      reverse: true,
      children: state.messages.map((Message message) {
        bool isCurrent = viewModel.isCurrentUser(message.userName);
        return ContextMenu(
          ...
          actions: [
            if (message.isPending == 2) ContextMenuAction(
